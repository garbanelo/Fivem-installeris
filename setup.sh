...
if [[ $install == true ]]; then
  bash <(curl -s https://raw.githubusercontent.com/garbanelo/Fivem-installeris/main/install.sh) $runtime_link
else
  bash <(curl -s https://raw.githubusercontent.com/garbanelo/Fivem-installeris/main/update.sh) $runtime_link
fi
